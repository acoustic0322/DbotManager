...
class TwitterAPI:
    ...
    def _ensure_tid_server_running(self):
        ...
        outputLog(f"current_dir={current_dir}")
        outputLog(f"script_path={script_path}")
        outputLog(f"script_exists={os.path.exists(script_path)}")
        outputLog(f"node_path={node_path}")
        outputLog(f"node_exists={os.path.exists(node_path)}")
