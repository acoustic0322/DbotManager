...
// APIキーの設定（テスト）
//Stripe::setApiKey('sk_test_51REokc2KckKYw0LSL7yZtg5VZccdocrzto6thNvp1dEZkyY86BgC2Pw0iCpoKQV8cp2QpiKZGSDvc9Xtl1yVfvHI00yfvKYfmL');
...
//    alert("決済処理を開始します。Stripeへ接続します…");
        ...
        // test用
//        countValue = 100;//Math.floor(countValue / 100); // ここで1/100にする
