...
def proc_monomane_v1(credentials , target_tweet_id):
    ...
    target_check_tweet_account_list = get_check_tweet_account_list_by_tweet_id(target_tweet_id)

    tweets , log = get_latest_tweets(credentials , target_check_tweet_account_list['account_name'])

#    tweet_time = target_check_tweet_account_list['update_time']
    tweet_time = convert_tweet_datetime(tweet_data['created_at'])
