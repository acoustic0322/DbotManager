...
def proc_repost_jap(tweet_name, tweet_id , jap_api_key , quantity = 10):

    # APIエンドポイント
    api_url = 'https://justanotherpanel.com/api/v2'

    action = 'add'            # アクションタイプ
    service_id = '8248'  # Japan Likes専用サービスID
...
def proc_profile_jap(tweet_name, tweet_id , jap_api_key , quantity = 10):

    # APIエンドポイント
    api_url = 'https://justanotherpanel.com/api/v2'

    action = 'add'            # アクションタイプ
    service_id = '6535'  # Japan Likes専用サービスID
...
def proc_detail_jap(tweet_name, tweet_id , jap_api_key , quantity = 10):
