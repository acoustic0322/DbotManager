...
bearer_token = "SGZvMlZZR2JlRGxMaGUtdlJfZ3NEcGF2LTlZZXYzUWlTMVJQcmx5TTBJRmxpOjE3MzE2MTQ0NTMxNzI6MToxOmF0OjE"
refresh_token = "Y1Npa0hkNUoyVUVIeFhRMGdIRFpSMTRjTWNXcDZuZUlnU0oxNHoxeml2RTUxOjE3MzE2MTQ0NTMxNzI6MTowOnJ0OjE"

bearer_token = "R0V6ZE5uSEoyY2E4NW1xaGpZTkxpOGtKN1NNd0syRjYzSjdXTFpfeklUeHNJOjE3MzE2MTQ1NjAyMjI6MTowOmF0OjE"
#refresh_token = "eWdCMU9zRjI4X0t3cHp4YnFhNEFyS18tVkZXLV9NVHdhc09wdVdsMWY1UW5jOjE3MzE2MTQ1NjAyMjM6MToxOnJ0OjE"
refresh_token = "test"
...
# ツイートのID
tweet_id = "1856986909073182748"#args[1]  # ここに対象のツイートのIDを入力してください
...
try:
    ...
    client = tweepy.Client(bearer_token=new_bearer_token, consumer_key=ck, consumer_secret=cs, access_token=at, access_token_secret=ats)
...
#        client.session.proxies = proxies
    ...
    try:
        new_bearer_token,new_refresh_token = refresh_access_token(client_id,client_secret,refresh_token)
        print("new_bearer_token2=",new_bearer_token)
        print("new_refresh_token2=",new_refresh_token)
