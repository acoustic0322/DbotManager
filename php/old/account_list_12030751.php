...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($type == 'user_del') {
        ...
        if ($count > 0) {
            ...
            // JavaScriptのアラートを使って出力
            echo "<script>alert('SQL: " . addslashes($reconstructed_sql) . "');</script>";
            */
...
<body>
   ...
   <form method="POST" action="?" class="registration-form">
        ...
        <div class="input-group" checkbox-group">
            <label>
                <input type="checkbox" name="new_enable">有効
            </label>
            <label>
