...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $reserve1_start_hour = $_POST['reserve1_start_hour'] ?? '';
    $reserve1_end_hour = $_POST['reserve1_end_hour'] ?? '';
...
<!--        <form action="?" method="post">  -->
        ...
        <div class="input-group" checkbox-group">
            <label>
                <input type="checkbox" name="paid" value="1" <?php echo !empty($edit_account['paid']) ? 'checked' : '' ?>>有効
            </label>
            <label>
        ...
        <div class="input-group">
            <label>
                <input type="checkbox" name="paid" value="1" <?php echo !empty($edit_account['like_enpaidable']) ? 'checked' : '' ?>>有料アカウント
            </label>
            <label>
...
<!--
            ...
            <label for="reserve1_enable">予約1有効:</label>
            ...
            <label for="reserve1_start_hour">予約1開始時間:</label>
            ...
            <label for="reserve1_end_hour">予約1終了時間:</label>
            ...
            <label for="reserve1_count">予約1回数:</label>
