...
//    echo $return_var;
    ...
    if ($return_var === 0 && isset($response['status']) && $response['status'] === 'success') {
        ...
        // PHPでアラートを表示
//        echo "<script>alert('Access Token: $access_token \\nAccess Token Secret: $access_token_secret');</script>";
    } else {
//        $error_message = $response['message'] ?? '不明なエラー';
//        echo "<script>alert('エラー: $error_message');</script>";
    }
