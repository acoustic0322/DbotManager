...
def check_access_token(credentials):
    oauth_type , contents = check_access_token_oauth_type(credentials['bearer_token'])
...
#    return True, contents
    ...
    if oauth_type == 200 :
#        if check_access_token_validity(credentials['bearer_token']) == 401:
#        if True:
...
def check_rate_limit2(access_token):
...
#        return
    ...
    # 投稿するデータ
    data = {
        "text": "Twitter APIehahaを使erhahって投稿しています！aaa"
    }
