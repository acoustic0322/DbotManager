...
def like_tweet2(credentials, tweet_id, account_id):
...
#    response = requests.post("https://api.twitter.com/2/tweets", headers=headers, json=data)
    response = requests.post("https://api.twitter.com/2/users/{account_id}/likes", headers=headers, json=data)
...
#                success , error_log = proc_like(credentials, tweet_id)
                success , error_log = like_tweet2(credentials, tweet_id , account_id)
