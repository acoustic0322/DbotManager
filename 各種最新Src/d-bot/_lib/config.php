...
function get_user($conn,$id){
    ...
    like_enable,bookmark_enable,reply_enable,repost_enable,sensyuken_enable,post_enable,reserve_enable,media_enable,check_enable,api_master_id,searchrep_enable
