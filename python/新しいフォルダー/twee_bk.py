...
def save_tweet_history(account_id, comment_id, mode, target_tweet_id , result , error_log):
    ...
    try:
        with connection.cursor() as cursor:
            sql = """
                INSERT INTO tweet_history (account_id, comment_id, _mode, target_tweet_id, updatetime , result , error_log)
...
#                error_log = proc_post(credentials, comment_id, "" , "1")
                ...
                error_log = proc_repost(credentials, tweet_id)
            elif mode == "like":
            ...
            if error_log == None:
                save_tweet_history(account_id, comment_id , mode , tweet_id , True , "")
                sys.exit(0)
            else:
