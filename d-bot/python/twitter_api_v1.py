...
#                        text=result,
#                        media_ids=media_ids,
#                        in_reply_to_tweet_id =reply_target_tweet_id  # 返信先のユーザーIDを指定
#                    )
#                else:
...
#                    response = client.create_tweet(
#                        text=result,
#                        in_reply_to_tweet_id =reply_target_tweet_id  # 返信先のユーザーIDを指定0
#                    )
#                else:
...
#            return False , str(ex)
        ...
        try:
#           insert_tweet_history_monomane(search_row , tweet_data.data , response)
            insert_tweet_history_monomane(search_row , tweet_data , None)
        except Exception as ex:
            outputLog('')

        # レスポンス内容を出力
        print("Response from client.create_tweet:")
        print(response)                
